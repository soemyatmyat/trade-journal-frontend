export const columns = [
  { field: 'category', header: 'Type', add: true, editable: true, filterable: true, options: ['Long', 'Put', 'Call', 'Short']},
  { field: 'open_date', header: 'Open Date', add: true, editable: true, filterable: true, type: 'datepicker' },
  { field: 'close_date', header: 'Close Date', add: true, editable: true, filterable: true, type: 'datepicker' },
  { field: 'ticker', header: 'Ticker', add: true, editable: false, filterable: true }, 
  { field: 'qty', header: 'Quantity', add: true, editable: true, filterable: true, type: 'float' },
  { field: 'option_price', header: 'Option', add: true, editable: true, filterable: true, type: 'float' },
  { field: 'trade_price', header: 'Trade Price', add: true, editable: true, filterable: true, type: 'float' },
  { field: 'closed_price', header: 'Closed Price', add: true, editable: true, filterable: true, type: 'float' },
